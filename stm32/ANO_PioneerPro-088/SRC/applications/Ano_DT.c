...
#define HCA_VEL_X      (ano_of.of2_dx_fix)//OF_DX2;光流速度
#define HCA_VEL_Y      (ano_of.of2_dy_fix)//OF_DY2;
#define HCA_VEL_Z      (wcz_spe_fus.out)
////0x08
#define ULHCA_POS_X      (pos.x)
#define ULHCA_POS_Y      (pos.y)

//#define ULHCA_POS_X      (displacement.X) //测试积分位置
//#define ULHCA_POS_Y      (displacement.Y)
