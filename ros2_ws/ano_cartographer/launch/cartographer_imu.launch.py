...
def generate_launch_description():
    return LaunchDescription([
        ...
        Node(
            package='ano_data',
            executable='node_pose_listener',
            name='pose_listener_node',
            output='screen',
        ),

        Node(
            package='ano_data',
            executable='node_rknn_link',
            name='rknn_link_node',
            output='screen',
        ),
        ...
        # Node(
        #     package='ano_data',
        #     executable='node_fly_mission',
        #     name='fly_mission_node',
        #     output='screen',
        # ),

        Node(
            package='ano_data',
            executable='node_normal_fly',
            name='fly_mission_node',
            output='screen',
        ),
        # Node(
